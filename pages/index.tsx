...
const IndexPage = () => (
  <Layout title="Home | Next.js + TypeScript Example">
    <h1>About Me</h1>
    <article>
      <p>Hi, my name is Mauro Colella. I am a senior software developer with twenty years of activity in the IT industry. I develop tailored solutions for great companies that offer great services.</p>
      ...
      <br/>
      <p>I have been successfully freelancing my services for the last ten years, with a strong focus on customer needs in both the business and the market.</p>
      <br/>
